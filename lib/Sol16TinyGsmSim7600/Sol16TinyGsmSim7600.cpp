...
void Sol16TinyGsmSim7600::light_sleep(uint32_t sec)
{
...
void Sol16TinyGsmSim7600::setup(bool led)
{
  // Set GSM module baud rate
  SerialAT.begin(UART_BAUD, SERIAL_8N1, MODEM_RX, MODEM_TX);

  // For controlling onboard LED
  // LED off to save battery
  pinMode(LED_PIN, OUTPUT);
  if (led)
  {
    digitalWrite(LED_PIN, HIGH);
    DBG("Onboard LED set to on");
  }
  else
  {
    digitalWrite(LED_PIN, LOW);
    DBG("Onboard LED set to off");
  }
...
bool Sol16TinyGsmSim7600::init_modem()
{
...
void Sol16TinyGsmSim7600::init_lte(const char apn[], const char gprs_user[], const char gprs_pass[])
{
...
void Sol16TinyGsmSim7600::init_gps()
{
  /**
...
bool Sol16TinyGsmSim7600::update_gps()
{
  bool updated = false;
...
gps Sol16TinyGsmSim7600::get_latest_gps()
{
  return _gps_info;
}

void Sol16TinyGsmSim7600::update_curr_datetime()
{
  for (int8_t i = 5; i; i--)
  {
...
String Sol16TinyGsmSim7600::get_str_datetime()
{
...
tm Sol16TinyGsmSim7600::get_tm_datetime()
{
  update_curr_datetime();
...
void Sol16TinyGsmSim7600::update_batt()
{
  int vref = 1.1;
...
double Sol16TinyGsmSim7600::get_remaining_batt()
{
  if (_batt_vec.empty())
  {
...
void Sol16TinyGsmSim7600::hibernate(unsigned long long duration)
{
